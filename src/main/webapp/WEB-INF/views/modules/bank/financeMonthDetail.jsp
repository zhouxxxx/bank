...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/bank/finance/monthDetail">用户列表</a></li>
</ul>
<form:form id="searchForm" modelAttribute="finance" action="${ctx}/bank/finance/monthDetail" method="post" class="breadcrumb form-search">
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    <thead><tr><th>姓名</th><th>身份证号</th><th>查询日期内存款</th><th>查询日期内取款</th></thead>
    <tbody>
    ...
    <c:forEach items="${page.list}" var="user">
        <tr>
            ...
            <td>${fns:abbr(user.qkMoney,40)}</td>
        </tr>
    </c:forEach>
    </tbody>
</table>
