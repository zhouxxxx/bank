...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/user/info">管理员信息</a></li>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/info" method="post" class="form-horizontal"><%--
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="mobile" htmlEscape="false" maxlength="50" class="phone"/>
			</div>
			<span></span>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="lbl"><fmt:formatDate value="${user.oldLoginDate}" type="both" dateStyle="full"/></label>
			</div>
		</div>
