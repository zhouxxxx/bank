	...
	<div class="row">
	   <div class="span2">
		...
		<div style="padding:0 0 20px;">
			...
			<form:form id="searchForm" modelAttribute="finance" action="${ctx}/toFinance" method="post" class="breadcrumb form-search">
			...
			<table id="contentTable" class="table table-striped table-bordered table-condensed">
				<thead><tr><th>转账流水号</th><th>转账对象</th><th>金额</th><th>时间</th></tr></thead>
				<tbody>
				...
				<c:forEach items="${page.list}" var="user">
					<tr>
						...
						<td>${fns:abbr(user.jsAccountId,40)}</td>
