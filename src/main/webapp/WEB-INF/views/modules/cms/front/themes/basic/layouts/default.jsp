...
<html>
<head>
	<title><sitemesh:title default="欢迎光临"/>农村合作社基金会财务管理系统-v1.0</title>
      ...
      <div class="navbar-inner">
        <div class="container">
          <c:choose>
   			...
   			<c:otherwise><a class="brand" href="">${site.title}</a></c:otherwise>
   		  </c:choose>
          <div class="nav-collapse">
            <ul id="main_nav" class="nav nav-pills">
				...
				<li><a href="/a/logout" title="退出登录">退出</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
